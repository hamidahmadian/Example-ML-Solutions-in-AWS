...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--use_8bit_adam", type=bool, default=False, help="Whether or not to use 8-bit Adam from bitsandbytes."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--enable_xformers_memory_efficient_attention", type=bool, default=False, help="Whether or not to use xformers."
    )
    parser.add_argument(
        "--set_grads_to_none",
        type=bool,
    ...
    parser.add_argument(
        "--skip_save_text_encoder", type=bool, default=False, required=False, help="Set to not save text encoder"
    )
    parser.add_argument(
        "--validation_images",
        required=False,
...
def main(args):
    ...
    # Handle instance_prompt args with _ :aws string issue=>
    if '_' in args.instance_prompt:
